...
describe("API Gateway Lambda Authorizer", () => {
    ...
    it("should allow requests with a valid JWT", async () => {
        const event = {
            headers: {
                Authorization: "Bearer VALID_WITH_GROUP",
            },
    ...
    it("should allow request when REQUIRED_GROUP_ID is in custom:groups", async () => {
        const event = {
    ...
    it("should deny request when REQUIRED_GROUP_ID is missing from custom:groups", async () => {
        const event = {
