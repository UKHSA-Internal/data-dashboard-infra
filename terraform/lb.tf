...
resource "aws_security_group" "load_balancer_security_group" {
  ...
  ingress {
    ...
    to_port     = 80
    protocol    = "tcp"
    cidr_blocks = ["82.16.94.117/32","5.71.224.176/32","81.141.183.138/32","81.187.210.205/32","137.22.182.58/32","62.253.228.2/32","94.192.79.9/32"90.209.237.170/32,"152.37.86.22/32","90.193.92.24/32","90.243.49.40/32,"147.12.250.190","90.193.92.24"] 
  }
