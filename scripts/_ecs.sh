...
function _get_most_recent_back_end_image() {
    ...
    most_recent_back_end_image_tag=$(echo uhd docker get-recent-tag $back_end_ecr_name)
...
function _get_most_recent_front_end_image() {
    ...
    most_recent_front_end_image_tag=$(echo uhd docker get-recent-tag $front_end_ecr_name)
